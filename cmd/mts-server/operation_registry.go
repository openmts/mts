...
func operationCatalog() []operation {
	return []operation{
		...
		},
		{
			...
			ResponseHint: "configValidateResponse{ok,errors?,admin_op_busy,last}",
			Auth:         authAdmin,
			HTTPMethods:  []string{http.MethodPost},
		...
		},
		{
			...
			ResponseHint: "versionResponse{version,commit?,admin_op_busy,last}",
			Auth:         authAdmin,
			HTTPMethods:  []string{http.MethodGet},
		...
		},
		{
			...
			ResponseHint: "storageValidateResponse{ok,data_dir,health,admin_op_busy,last}",
			Auth:         authAdmin,
			HTTPMethods:  []string{http.MethodPost},
