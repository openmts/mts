...
func operationCatalog() []operation {
	return []operation{
		...
		},
		{
			...
			ResponseHint: "queryRowsResponse{rows,stats?,admin_op_busy,last?}",
			Auth:         authDataToken,
			HTTPMethods:  []string{http.MethodPost},
		...
		},
		{
			...
			ResponseHint: "queryColumnsResponse{columns,stats?,admin_op_busy,last?}",
			Auth:         authDataToken,
			HTTPMethods:  []string{http.MethodPost},
		...
		},
		{
			...
			ResponseHint: "queryExplainResponse{plan,stats?,admin_op_busy,last?}",
			Auth:         authDataToken,
			HTTPMethods:  []string{http.MethodPost},
