...
func operationCatalog() []operation {
	return []operation{
		...
		// downsample
		{
			...
			ResponseHint: "downsamplePoliciesResponse|okResponse (+admin_op_busy/last)",
			Auth:         authAdmin,
		...
		},
		{
			...
			ResponseHint: "downsamplePolicyResponse|downsamplePolicyStatusResponse|okResponse by policy action (+admin_op_busy/last)",
			Auth:         authAdmin,
			HTTPMethods:  []string{http.MethodGet, http.MethodPost, http.MethodDelete},
