...
func operationCatalog() []operation {
	return []operation{
		...
		// users (collection + resource)
		{
			...
			ResponseHint: "usersResponse|okResponse (+admin_op_busy/last on GET/create)",
			Auth:         authAdmin,
		...
		},
		{
			...
			ResponseHint: "user|permissions|setPasswordResponse|okResponse(+admin_op_busy/last; disable/enable writes user_disable|user_enable last)",
			Auth:         authAdmin,
		...
		},
		{
			...
			ResponseHint: "batchMutationResponse{ok,ok_count,skip_count,fail_count,items,admin_op_busy,last}",
			Auth:         authAdmin,
			HTTPMethods:  []string{http.MethodPost},
		...
		},
		{
			...
			ResponseHint: "doctorResponse{ok,checks,admin_op_busy,last}",
			Auth:         authAdmin,
			HTTPMethods:  []string{http.MethodGet},
		...
		},
		{
			...
			ResponseHint: "adminHealthResponse{...admin_op_busy,last}",
			Auth:         authAdmin,
			HTTPMethods:  []string{http.MethodGet},
