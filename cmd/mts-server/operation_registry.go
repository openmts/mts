...
func operationCatalog() []operation {
	return []operation{
		...
		},
		{
			...
			ResponseHint: "changePasswordResponse{ok,must_change_password=false,admin_op_busy,last}",
			Auth:         authUserPass,
			HTTPMethods:  []string{http.MethodPost},
		...
		},
		{
			...
			ResponseHint: "storageDataSnapshotsResponse{items,admin_op_busy,last}",
			Auth:         authAdmin,
			HTTPMethods:  []string{http.MethodGet},
		...
		},
		{
			...
			ResponseHint: "storageSnapshotsResponse{items,admin_op_busy,last}",
			Auth:         authAdmin,
