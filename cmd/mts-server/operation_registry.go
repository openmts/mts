...
func operationCatalog() []operation {
	return []operation{
		...
		// admin config / contract
		{
			...
			ResponseHint: "configResponse{config,admin_op_busy,last}",
			Auth:         authAdmin,
			HTTPMethods:  []string{http.MethodGet},
		...
		},
		{
			...
			ResponseHint: "configSchemaResponse{schema,admin_op_busy,last}",
			Auth:         authAdmin,
			HTTPMethods:  []string{http.MethodGet},
		...
		},
		{
			...
			ResponseHint: "apiSpecResponse{version,namespaces[].endpoints[].response?,admin_op_busy,last}",
			Auth:         authAdmin,
			HTTPMethods:  []string{http.MethodGet},
		...
		},
		{
			...
			ResponseHint: "errorCodesResponse{codes[{code,http_status,grpc_code,description,retryable,category,remediation,dashboard_path}],admin_op_busy,last}",
			Auth:         authAdmin,
			HTTPMethods:  []string{http.MethodGet},
		...
		},
		{
			...
			ResponseHint: "maintenanceResponse{errors,admin_op_busy,last}",
			Auth:         authAdmin,
			HTTPMethods:  []string{http.MethodGet},
		...
		},
		{
			...
			ResponseHint: "maintenanceStatsResponse{...admin_op_busy,last}",
			Auth:         authAdmin,
			HTTPMethods:  []string{http.MethodGet},
		...
		},
		{
			...
			ResponseHint: "adminOpStatus{admin_op_busy,op,started_at_unix,last}",
			Auth:         authAdmin,
			HTTPMethods:  []string{http.MethodGet},
		...
		},
		{
			...
			ResponseHint: "storageMemoryResponse{...admin_op_busy,last}",
			Auth:         authAdmin,
			HTTPMethods:  []string{http.MethodGet},
		...
		},
		{
			...
			ResponseHint: "compactionStatsResponse{...admin_op_busy,last}",
			Auth:         authAdmin,
			HTTPMethods:  []string{http.MethodGet},
		...
		},
		{
			...
			ResponseHint: "storageRestoreDrillResponse{path,admin_op_busy,last}",
			Auth:         authAdmin,
			HTTPMethods:  []string{http.MethodPost},
