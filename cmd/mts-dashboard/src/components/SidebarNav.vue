...
import {
  ...
  ArrowDownUp, Search, ScrollText, HardDrive, Send, X,
  ...
  <div>
    ...
    >
      <div class="flex h-14 items-center justify-between border-b border-slate-200 px-4 dark:border-slate-700">
        ...
        <button class="rounded p-1 text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 lg:hidden" @click="emit('close')">
          <X class="h-4 w-4" />
        </button>
      </div>
